...
##CODE DERIVED FROM Adrian Rosebrock
...
#set up Microsoft Cog Services API key along with max number of results for given search and group size for results

API_KEY = "90a7a8386017409695363c7a7deb3ec9"
MAX_RESULTS = 100
GROUP_SIZE = 20
